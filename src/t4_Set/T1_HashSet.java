...
//		Set<String> hash = new HashSet<>();
		...
		System.out.println("2. toString: "+hash); // 순서에 관계없다
		System.out.println();
		
		hash.add("홍길동");
		System.out.println("3. 크기: "+hash.size());
		System.out.println("3. toString: "+hash); // 같은 자료를 넣으면 덮어씀
		System.out.println();
		
		hash.add(new String("홍길동"));
		System.out.println("4. 크기: "+hash.size());
		System.out.println("4. toString: "+hash); // new로 생성해도 같은 걸로 보고 덮어씀
		System.out.println();
